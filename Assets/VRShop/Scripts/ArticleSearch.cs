...
public class ArticleSearch : MonoBehaviour {
    ...
    private const string DEFAULT_TEXT = "To search the microphone ..."; //Zur Suche ins Mikrofon sprechen...
    private const string MICROPHONE_ERROR_TEXT = "Error in speech recognition! Please use keyboard ..."; //Fehler bei der Spracherkennung! Bitte Tastatur verwenden...

    public string debugTriggerWord = "everything"; //alles
    public bool isWaitingForInput;
    public static bool callCount=false;
